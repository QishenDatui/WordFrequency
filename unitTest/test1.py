...
class TestVerbsPrepositions(unittest.TestCase):
    ...
    def test_verbsword_init(self):
        ...
        result = [('abase', 100), ('abate',100), ('the',50)]
        self.assertEqual(count, result)
    ...
    def test_verbsphrase_stop(self):
        ...
        phrase = 2
        count = fileVerbsPharseCounter(filepath, 10, stopwordpath, phrase, verbs)
        result = [('abase kod', 100), ('abate boy',100)]
        self.assertEqual(count, result)

    def test_verbsphrase_nofile(self):
        filepath = "./wrong.txt"
        with self.assertRaises(FileNotFoundError):
            count = fileVerbsPharseCounter(filepath, 10, None, 2, None)
